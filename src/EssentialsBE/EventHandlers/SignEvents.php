...
class SignEvents extends BaseEventHandler{
    ...
    public function onSignTap(PlayerInteractEvent $event){
        ...
        if($tile instanceof Sign){
            ...
            // Warp sign
            elseif(TextFormat::clean($tile->getText()[0], true) === "[Warp]" && $this->getAPI()->getEssentialsBEPlugin()->getServer()->getPluginManager()->getPlugin("SimpleWarp") === null && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("warps") === true){
                $event->setCancelled(true);
            ...
            // Balance sign
            elseif(TextFormat::clean($tile->getText()[0], true) === "[Balance]" && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("economy") === true){
                $event->setCancelled(true);
            ...
            // BalanceTop sign
            elseif(TextFormat::clean($tile->getText()[0], true) === "[BalanceTop]" && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("economy") === true){
                $event->setCancelled(true);
            ...
            // Buy sign
            elseif(TextFormat::clean($tile->getText()[0], true) === "[Buy]" && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("economy") === true){
                $event->setCancelled(true);
            ...
            // Sell sign
            elseif(TextFormat::clean($tile->getText()[0], true) === "[Sell]" && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("economy") === true){
                $event->setCancelled(true);
    ...
    public function onSignChange(SignChangeEvent $event){
        ...
        elseif(strtolower(TextFormat::clean($event->getLine(0), true)) === "[gamemode]" && $event->getPlayer()->hasPermission("essentials.sign.create.gamemode")){
            ...
            if(is_numeric($price) && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("economy") === true) {
        ...
        // Warp sign
        elseif(strtolower(TextFormat::clean($event->getLine(0), true)) === "[warp]" && $event->getPlayer()->hasPermission("essentials.sign.create.warp") && $this->getAPI()->getEssentialsBEPlugin()->getServer()->getPluginManager()->getPlugin("SimpleWarp") === null && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("warps") === true){
        ...
        // BalanceTop sign
        elseif(strtolower(TextFormat::clean($event->getLine(0), true)) === "[balancetop]" && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("economy") === true) {
        ...
        // Balance sign
        elseif(strtolower(TextFormat::clean($event->getLine(0), true)) === "[balance]" && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("economy") === true) {
        ...
        // Buy sign
        elseif(strtolower(TextFormat::clean($event->getLine(0), true)) === "[buy]" && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("economy") === true){
        ...
        elseif(strtolower(TextFormat::clean($event->getLine(0), true)) === "[sell]" && $this->getAPI()->getEssentialsBEPlugin()->getConfig()->get("economy") === true){
